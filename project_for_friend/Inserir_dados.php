...
<p>
<br> 
<input class="btn" type="submit" name="submit" value="Adicionar"><br> </p>
...
mysql_query("INSERT bilheteira SET id_motorista='$firstname1', carreira='$lastname1', hora='$firstname2', b_inicial='$lastname2', b_final='$firstname3', serie_inicial='$lastname3', serie_final='$firstname4'")
